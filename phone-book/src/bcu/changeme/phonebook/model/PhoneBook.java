 ...
 * Models a phone book 
 * 
 * stores a phone number associated with each name.
 * 
 * Names are case-insensitive when used to get, update or remove an
 * entry, but the phone book stores names with their original capitalisation.
 * <p>
 * for example: calling PhoneBook.Addentry {@code PhoneBook add.entry("Alice", "555-1234")}
 * then{@code}
 * 
 * 
 */
